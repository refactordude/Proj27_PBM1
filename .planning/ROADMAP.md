...
**Plans**: 2 plans
- [x] 03-01-PLAN.md — AgentStep dataclass + run_agent_turn loop (AGENT-01..06, OBS-02) + log_llm extension (Wave 1)
- [x] 03-02-PLAN.md — Integration tests covering SC1-SC5 + AGENT-07 regression (TEST-02, TEST-03, TEST-05) (Wave 2)
**UI hint**: no
